...
use Illuminate\Support\Facades\Auth; // Perbaikan namespace Auth
use Illuminate\Support\Str;          // Perbaikan namespace Str
...
class StoreController extends Controller
{
    ...
    public function payment_status($order_id){
        ...
        try {
            ...
            $order->save();
			return redirect()->route('store')->with('error', 'Unable to retrieve payment status: ' . $e->getMessage());
        }
